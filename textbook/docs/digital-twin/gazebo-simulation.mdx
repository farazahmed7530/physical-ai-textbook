...
> **Estimated Time:** 75 minutes | **Difficulty:** Intermediate | **Hands-on:** Yes

Welcome to the world of robot simulation! Gazebo is a powerful physics simulation environment that allows you to test robot behaviors in a virtual world before deploying to real hardware.

:::info What You'll Build
By the end of this chapter, you'll have a working Gazebo simulation with a robot that responds to commands—your own digital twin for safe experimentation.
:::

:::caution Important
This chapter includes the **Interactive 3D Robot Playground**. Make sure you complete the hands-on exercises to get the most out of this module.
:::
...
One of the biggest challenges in robotics is the "reality gap"—the difference between how robots behave in simulation versus the real world. Understanding this gap is essential for successful sim-to-real transfer.

| Aspect | Simulation | Real World |
|--------|------------|------------|
| **Physics** | Idealized, deterministic | Complex, stochastic |
| **Sensors** | Perfect, noise-free | Noisy, calibration drift |
| **Actuators** | Instant response | Delays, backlash, wear |
| **Environment** | Fully known | Partially observable |
| **Collisions** | Clean contact models | Deformation, friction variation |
| **Lighting** | Controlled | Variable, shadows, reflections |
| **Reset** | Instant, unlimited | No reset possible |
| **Time** | Can speed up/slow down | Fixed real-time |
| **Failure** | No consequences | Hardware damage, safety risks |
| **Cost per Trial** | Near zero | Expensive (time, wear, risk) |

<div className="key-takeaway">

**Bridging the Gap:** The key to successful sim-to-real transfer is domain randomization—training your robot across many variations of physics parameters, sensor noise, and environmental conditions so it learns robust behaviors that transfer to the real world.

</div>

:::caution The Reality Gap Warning
A policy that achieves 100% success in simulation may fail completely in the real world. Always:
1. Add realistic sensor noise to your simulation
2. Randomize physics parameters (friction, mass, delays)
3. Test with domain randomization before real deployment
4. Start with conservative, safe behaviors on real hardware
:::
...
#### Exercise: Launch Your First Gazebo Simulation

In this exercise, you'll launch Gazebo and spawn a simple robot model.

**Step 1:** Launch an empty Gazebo world:
```bash
gz sim empty.sdf
```

**Step 2:** In another terminal, spawn a simple shape:
```bash
gz service -s /world/empty/create \
  --reqtype gz.msgs.EntityFactory \
  --reptype gz.msgs.Boolean \
  --timeout 1000 \
  --req 'sdf: "<model name=\"box\"><pose>0 0 0.5 0 0 0</pose><link name=\"link\"><collision name=\"collision\"><geometry><box><size>1 1 1</size></box></geometry></collision><visual name=\"visual\"><geometry><box><size>1 1 1</size></box></geometry></visual></link></model>"'
```

**Step 3:** Observe the box falling due to gravity in the simulation.

<div className="expected-output">
A 1x1x1 meter box appears at height 0.5m and falls to the ground plane.
The box settles on the ground after bouncing slightly.
</div>
...
<span className="question-number">Q1.</span> What is the default direction of gravity in Gazebo?
...
<div className="question">
<span className="question-number">Q2.</span> Which physics engine is recommended for humanoid robot simulation?
<div className="options">
...
<div className="question">
<span className="question-number">Q3.</span> What is the purpose of the `ros_gz_bridge` package?
<div className="options">

- A) To render graphics
- B) To connect Gazebo topics to ROS 2 topics ✓
- C) To compile URDF files
...
<div className="question">
<span className="question-number">Q4.</span> What timestep should you use for accurate physics simulation?
<div className="options">
...
<a href="/digital-twin/robot-description-formats" className="next-chapter">
  Next: Robot Description Formats (URDF & SDF) →
</a>
