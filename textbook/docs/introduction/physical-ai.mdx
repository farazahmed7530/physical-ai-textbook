...
import { PersonalizeButton } from '@site/src/components/PersonalizationControls';
import { TranslateButton } from '@site/src/components/TranslationControls';

<div style={{display: 'flex', gap: '10px', marginBottom: '20px'}}>
  <PersonalizeButton chapterId="introduction-physical-ai" />
  <TranslateButton chapterId="introduction-physical-ai" />
</div>
