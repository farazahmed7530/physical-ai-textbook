...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px', marginBottom: '24px'}}>
  <div style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '12px', padding: '20px', color: 'white'}}>
    <h4 style={{margin: '0 0 12px 0', fontSize: '1.1rem'}}>🚀 Node Lifecycle</h4>
    <code style={{display: 'block', background: 'rgba(0,0,0,0.3)', padding: '8px', borderRadius: '6px', fontSize: '0.85rem'}}>
      rclpy.init() → Node() → spin() → shutdown()
    </code>
  </div>
  <div style={{background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', borderRadius: '12px', padding: '20px', color: 'white'}}>
    <h4 style={{margin: '0 0 12px 0', fontSize: '1.1rem'}}>📡 Communication</h4>
    <code style={{display: 'block', background: 'rgba(0,0,0,0.3)', padding: '8px', borderRadius: '6px', fontSize: '0.85rem'}}>
  ...
  <div style={{background: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', borderRadius: '12px', padding: '20px', color: 'white'}}>
    <h4 style={{margin: '0 0 12px 0', fontSize: '1.1rem'}}>🧠 AI Libraries</h4>
    <code style={{display: 'block', background: 'rgba(0,0,0,0.3)', padding: '8px', borderRadius: '6px', fontSize: '0.85rem'}}>
      NumPy + OpenCV + PyTorch + cv_bridge
    </code>
  </div>
  <div style={{background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)', borderRadius: '12px', padding: '20px', color: 'white'}}>
    <h4 style={{margin: '0 0 12px 0', fontSize: '1.1rem'}}>⚡ Executors</h4>
    <code style={{display: 'block', background: 'rgba(0,0,0,0.3)', padding: '8px', borderRadius: '6px', fontSize: '0.85rem'}}>
      SingleThreaded | MultiThreaded | Async
    </code>
  </div>
</div>
...
<div style={{background: '#1a1a2e', borderRadius: '12px', padding: '20px', marginBottom: '24px'}}>
  <div style={{display: 'flex', justifyContent: 'space-between', marginBottom: '8px'}}>
    <span style={{color: '#64ffda'}}>Chapter Completion</span>
    <span style={{color: '#64ffda'}}>0%</span>
  </div>
  <div style={{background: 'rgba(100, 255, 218, 0.2)', borderRadius: '8px', height: '12px', overflow: 'hidden'}}>
    <div style={{background: 'linear-gradient(90deg, #64ffda, #4facfe)', height: '100%', width: '0%', borderRadius: '8px', transition: 'width 0.3s'}}></div>
  </div>
  <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginTop: '16px'}}>
    <div style={{textAlign: 'center', padding: '8px', background: 'rgba(100, 255, 218, 0.1)', borderRadius: '6px'}}>
      <div style={{fontSize: '1.5rem'}}>📖</div>
      <div style={{fontSize: '0.75rem', color: 'rgba(255,255,255,0.7)'}}>Basics</div>
    </div>
    <div style={{textAlign: 'center', padding: '8px', background: 'rgba(100, 255, 218, 0.1)', borderRadius: '6px'}}>
      <div style={{fontSize: '1.5rem'}}>🔧</div>
      <div style={{fontSize: '0.75rem', color: 'rgba(255,255,255,0.7)'}}>Executors</div>
    </div>
    <div style={{textAlign: 'center', padding: '8px', background: 'rgba(100, 255, 218, 0.1)', borderRadius: '6px'}}>
      <div style={{fontSize: '1.5rem'}}>🤖</div>
      <div style={{fontSize: '0.75rem', color: 'rgba(255,255,255,0.7)'}}>AI Integration</div>
    </div>
    <div style={{textAlign: 'center', padding: '8px', background: 'rgba(100, 255, 218, 0.1)', borderRadius: '6px'}}>
      <div style={{fontSize: '1.5rem'}}>✅</div>
      <div style={{fontSize: '0.75rem', color: 'rgba(255,255,255,0.7)'}}>Best Practices</div>
    </div>
  </div>
</div>
...
| Objective | Skill Level | Time |
|-----------|-------------|------|
| 🟢 Use rclpy to create ROS 2 nodes in Python | Beginner | 15 min |
| 🟡 Bridge Python AI agents to ROS 2 controllers | Intermediate | 30 min |
| 🟡 Handle asynchronous operations with executors | Intermediate | 25 min |
| 🔴 Integrate NumPy, OpenCV, PyTorch with ROS 2 | Advanced | 45 min |
| 🟡 Implement best practices for development | Intermediate | 20 min |
| 🟢 Debug and profile Python ROS 2 applications | Beginner | 15 min |

:::tip 💡 Pro Tip
Start with the interactive robot demo below to see Python ROS 2 in action before diving into the code!
:::
...
## 📋 Python ROS 2 Cheat Sheet

<div style={{background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)', borderRadius: '16px', padding: '24px', marginTop: '24px'}}>
...
<div style={{background: 'rgba(100, 255, 218, 0.1)', borderRadius: '8px', padding: '16px', border: '1px solid rgba(100, 255, 218, 0.3)'}}>
<h4 style={{color: '#64ffda', margin: '0 0 8px 0'}}>Publisher</h4>
...
<div style={{background: 'rgba(100, 255, 218, 0.1)', borderRadius: '8px', padding: '16px', border: '1px solid rgba(100, 255, 218, 0.3)'}}>
<h4 style={{color: '#64ffda', margin: '0 0 8px 0'}}>Subscriber</h4>
...
<div style={{background: 'rgba(100, 255, 218, 0.1)', borderRadius: '8px', padding: '16px', border: '1px solid rgba(100, 255, 218, 0.3)'}}>
<h4 style={{color: '#64ffda', margin: '0 0 8px 0'}}>Timer</h4>

```python
self.timer = self.create_timer(
    0.1, self.timer_callback  # 10 Hz
)
```
</div>

<div style={{background: 'rgba(100, 255, 218, 0.1)', borderRadius: '8px', padding: '16px', border: '1px solid rgba(100, 255, 218, 0.3)'}}>
<h4 style={{color: '#64ffda', margin: '0 0 8px 0'}}>Parameter</h4>
...
<div style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '16px', padding: '32px', textAlign: 'center', marginTop: '24px'}}>
  <h3 style={{color: 'white', margin: '0 0 16px 0', fontSize: '1.5rem'}}>🎉 Congratulations!</h3>
  <p style={{color: 'rgba(255,255,255,0.9)', margin: '0 0 24px 0'}}>
    You've mastered Python ROS 2 Integration. You can now build AI-powered robot applications!
  </p>
  <div style={{display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap'}}>
    <div style={{background: 'rgba(255,255,255,0.2)', borderRadius: '8px', padding: '12px 24px'}}>
      <div style={{fontSize: '2rem'}}>🐍</div>
      <div style={{color: 'white', fontSize: '0.85rem'}}>rclpy Master</div>
    </div>
    <div style={{background: 'rgba(255,255,255,0.2)', borderRadius: '8px', padding: '12px 24px'}}>
      <div style={{fontSize: '2rem'}}>🤖</div>
      <div style={{color: 'white', fontSize: '0.85rem'}}>AI Integration</div>
    </div>
    <div style={{background: 'rgba(255,255,255,0.2)', borderRadius: '8px', padding: '12px 24px'}}>
      <div style={{fontSize: '2rem'}}>⚡</div>
      <div style={{color: 'white', fontSize: '0.85rem'}}>Async Expert</div>
    </div>
  </div>
</div>
