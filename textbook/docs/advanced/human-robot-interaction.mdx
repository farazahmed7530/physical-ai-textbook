...
<div style={{display: 'flex', gap: '10px', marginBottom: '20px'}}>
  <ChapterPersonalizeButton chapterId="advanced-human-robot-interaction" />
  <ChapterTranslateButton chapterId="advanced-human-robot-interaction" />
</div>
...
A complete HRI system integrates perception, cognition, and interaction:
...
graph TB
    ...
    subgraph "Social Cognition"
        INTENT[Intent Recognition]
        EMO[Emotion Detection]
        ATT[Attention Modeling]
        TRUST[Trust Estimation]
    end

    subgraph "Interaction Generation"
        SPEECH[Speech Synthesis]
        MOTION[Social Motion]
        GAZE[Gaze Control]
        EXPR[Expression Control]
    end
